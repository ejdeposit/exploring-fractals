...
int project(double observer_distance, double halfangle_degrees){
    ...
    */
    ...
    for(int i =0; i<N; i++){
        Xplot[i] = (Wsize / halfangle_degrees * observer_distance * X[i] / (observer_distance + Z[i])) + 300;
        Yplot[i] = (Wsize / halfangle_degrees * observer_distance * Y[i] / (observer_distance + Z[i])) + 300;
    }
