...
int main(){
    ...
    */
    ...
    diameterXOffset =  diameterXOffset / (numCircles);
    diameterYOffset =  diameterYOffset / (numCircles);

    xDist = abs(startX - endX);
    yDist = abs(startY - endY);
    diameter = sqrt(xDist * xDist + yDist * yDist) / (numCircles) / 2;
    centerX = startX + diameterXOffset/2;
    centerY =  startY + diameterYOffset/2;
